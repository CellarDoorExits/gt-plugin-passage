...
import {
  ...
  signMarker,
  verifyMarker
} from "./chunk-H5F44PDI.js";
import "./chunk-CFRFGOQV.js";
import "./chunk-KKNMKJSS.js";
import {
  addModule,
  createAnchorRecord,
  createMarker
} from "./chunk-PXQJCDFL.js";
import "./chunk-LY5BBBIO.js";
...
`).option("--show-keys", "Print private key to stdout (DANGER: do not use in production logs)").action(withErrorHandling((opts) => {
  const kp = generateKeyPair();
  ...
  if (opts.showKeys) {
    ...
    writeFileSync(keyFileName, toHex(kp.privateKey), { mode: 384 });
    console.log(
      JSON.stringify(
        {
          did,
